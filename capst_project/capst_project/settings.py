"""
Django settings for capst_project project.
...
SECRET_KEY = 'django-insecure-xyw@l@--chii_1pc8fi14&6919uom@k@f4o(4*@l^*sc+67b#l'
...
ROOT_URLCONF = 'capst_project.urls'
...
WSGI_APPLICATION = 'capst_project.wsgi.application'
